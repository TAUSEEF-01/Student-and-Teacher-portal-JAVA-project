...
////        String insertToRegister = insertFields + insertValues;
        ...
        String insertFields = "INSERT INTO logintable (firstname, lastname, email, reg, Roll, password, username) VALUES ('";
        String insertValues = firstname + "','" + lastname + "','" + email + "','" + registration + "','" + roll + "','" + password + "','" + username + "')";
        String insertToRegister = insertFields + insertValues;
    ...
    public void redirectLoginPage() {
        try {
            Parent root2 = FXMLLoader.load(getClass().getResource("StudentLogin.fxml"));
